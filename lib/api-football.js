...
async function request(path,params={}){
  ...
  const res=await fetch(url,{headers:{'x-apisports-key':key()},next:{revalidate:600}});
...
export const recentAF=(teamId,last=20)=>request('/fixtures',{team:teamId,last});
...
export const teamStatsAF=(league,season,team)=>request('/teams/statistics',{league,season,team});
